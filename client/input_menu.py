...
class StorageListWidget(QWidget):
    ...
    def __init__(self, parent=None, storages: list = None):
        ...
        self.storage_layout.setContentsMargins(8, 8, 8, 8)
        self.storage_layout.setSpacing(5)
    ...
    def _add_storage_item(self):
        ...
        item_widget.setFixedHeight(140)
        ...
        storage_widget.setMinimumWidth(450)
        ...
        QTimer.singleShot(100, show_list_delayed)
        remove_btn = QPushButton("✕")
        remove_btn.setMinimumSize(25, 25)
        ...
        """)
        disk_label.setAlignment(Qt.AlignmentFlag.AlignTop)
...
class InputMenu(QDialog):
    ...
    def create_ram_tab(self):
        ...
        self.ram_modules_slider.setMaximumWidth(200)
    ...
    def create_cooling_tab(self):
        ...
        """)
        self.cooling_widget.listw.setMinimumHeight(200)
    ...
    def create_motherboard_tab(self):
        ...
        """)
        self.motherboard_widget.listw.setMinimumHeight(200)
    ...
    def create_settings_tab(self):
        ...
        self.power_margin_slider.setMinimumHeight(50)
